...
use rsa_crypt::crypt::api::keyitem::{
    AsymmetricKey,
    PublicAsymmetricKeyTrait,
    PrivateAsymmetricKeyTrait
};
...
#[test]
fn test_init_8() {
    let key: AsymmetricKey<u8> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_8, &SAMPLE_PRIVATE_8
    );
...
fn test_init_only_public_8() {
    let key: AsymmetricKey<u8> = AsymmetricKey::only_public(
        &SAMPLE_PUBLIC_8
    );
...
fn test_init_only_private_8() {
    let key: AsymmetricKey<u8> = AsymmetricKey::only_private(
        &SAMPLE_PRIVATE_8
    );
...
#[test]
fn test_init_16() {
    let key: AsymmetricKey<u16> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_16, &SAMPLE_PRIVATE_16
    );
...
fn test_init_only_public_16() {
    let key: AsymmetricKey<u16> = AsymmetricKey::only_public(
        &SAMPLE_PUBLIC_16
    );
...
fn test_init_only_private_16() {
    let key: AsymmetricKey<u16> = AsymmetricKey::only_private(
        &SAMPLE_PRIVATE_16
    );
...
#[test]
fn test_init_32() {
    let key: AsymmetricKey<u64> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_64, &SAMPLE_PRIVATE_64
    );
...
#[test]
fn test_clone_32() {
    let key: AsymmetricKey<u32> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_32, &SAMPLE_PRIVATE_32
    );
...
fn test_init_only_public_32() {
    let key: AsymmetricKey<u32> = AsymmetricKey::only_public(
        &SAMPLE_PUBLIC_32
    );
...
fn test_init_only_private_32() {
    let key: AsymmetricKey<u32> = AsymmetricKey::only_private(
        &SAMPLE_PRIVATE_32
    );
...
fn test_init_only_public_64() {
    let key: AsymmetricKey<u64> = AsymmetricKey::only_public(
        &SAMPLE_PUBLIC_64
    );
...
fn test_init_only_private_64() {
    let key: AsymmetricKey<u64> = AsymmetricKey::only_private(
        &SAMPLE_PRIVATE_64
    );
...
fn test_key_inequality_8() {
    let key1: AsymmetricKey<u8> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_8_1, &SAMPLE_PRIVATE_8_1
    );
    let key2: AsymmetricKey<u8> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_8_2, &SAMPLE_PRIVATE_8_2
    );
...
fn test_key_inequality_16() {
    let key1: AsymmetricKey<u16> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_16_1, &SAMPLE_PRIVATE_16_1
    );
    let key2: AsymmetricKey<u16> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_16_2, &SAMPLE_PRIVATE_16_2
    );
...
fn test_key_inequality_32() {
    let key1: AsymmetricKey<u32> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_32_1, &SAMPLE_PRIVATE_32_1
    );
    let key2: AsymmetricKey<u32> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_32_2, &SAMPLE_PRIVATE_32_2
    );
...
fn test_key_inequality_64() {
    let key1: AsymmetricKey<u64> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_64_1, &SAMPLE_PRIVATE_64_1
    );
    let key2: AsymmetricKey<u64> = AsymmetricKey::new(
        &SAMPLE_PUBLIC_64_2, &SAMPLE_PRIVATE_64_2
    );
